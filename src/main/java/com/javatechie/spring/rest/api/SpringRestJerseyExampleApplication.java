...
public class SpringRestJerseyExampleApplication {
	...
	@PostConstruct
	public void initDB() {
		dao.saveAll(Stream.of(new Employee(110,"Chhote","QA"),new Employee(890,"peter","DEV"),new Employee(680,"sam","QA"),new Employee(143,"John","HR")).collect(Collectors.toList()));
	}
